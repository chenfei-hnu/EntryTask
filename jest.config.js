module.exports = {
    ...
    moduleNameMapper: {
        ...
        '^@Header(.*)$': '<rootDir>/src/components/header/Header.tsx',
        '^@PrivateRoute(.*)$':
            '<rootDir>/src/components/common/PrivateRoute.tsx',
        ...
        '^@Utils(.*)$': '<rootDir>/src/util/utils.tsx',
        '^@App(.*)$': '<rootDir>/src/pages/App.tsx',
    },

...
const event = {
    ...
    creator: {
        ...
        createdAt: '2020-04-27T09:39:38.398Z',
        updatedAt: '2020-04-27T09:39:38.398Z',
    },
    images: [
...
describe('EventPreview Test', () => {
    ...
    test('测试有图片的活动是否显示正常', () => {
        ...
        expect(wrapper.find('.icon-time').text()).toBe(
            '27 Apr 2020 - 28 Apr 2020'
        );
    });
    test('测试没有图片的活动是否显示正常', () => {
        ...
        expect(wrapper.find('.icon-time').text()).toBe(
            '27 Apr 2020 17:39 - 28 Apr 2020 17:39'
        );
    });

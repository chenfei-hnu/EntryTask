    ...
    return (
        <div className={`header-topContainer`}>
            ...
            {isListPage ? (
                ...
                <Link to="/" className={`header-topBtn header-homeBtn`}>
                    <i className={`icon-home`}></i>
                </Link>
            )}
            <div className={`header-topBtn  header-logoBtn`}>
            ...
            >
                <i
                    className={`icon-${
                        langType === 'en' ? 'zhType' : 'enType'
                    }`}
                ></i>
            </div>
            <Link to="/setting" className={`header-topBtn header-avatarBtn`}>
                <img
                    loading={'lazy'}

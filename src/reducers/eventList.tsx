...
export type ITab =
  | { type: 'Likes'; icon: 'like', count: number, me?: boolean, meText?: string, flex: 1 }
  | { type: 'Going'; icon: 'check', count: number, me?: boolean, meText?: string, flex: 1 }
  | { type: 'Past'; icon: 'past', count: number, me?: boolean, meText?: '', flex: 1 }
  | { type: 'Details'; icon: 'info', count?: number, me?: boolean, meText?: '', flex: 1 }
  | { type: 'Participants'; icon: 'people', count?: number, me?: boolean, meText?: '', flex: 1.3 | 1 }
  | { type: 'Commens'; icon: 'comment', count?: number, me?: boolean, meText?: '', flex: 1 };

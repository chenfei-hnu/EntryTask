...
module.exports = {
    ...
    resolve: {
        ...
        alias: { // 减少使用别名提高编译速速
            ...
            '@PrivateRoute': path.join(__dirname, './src/components/PrivateRoute.tsx'),
            '@context': path.join(__dirname, './src/context'),
            '@reducers': path.join(__dirname, './src/reducers'),
            '@Routes': path.join(__dirname, './src/routes/Routes.tsx'),
            '@Types': path.join(__dirname, './src/types/index.tsx'),
            '@assets': path.join(__dirname, './src/assets'),
            '@Lang': path.join(__dirname, './src/assets/lang.tsx'),
            '@Utils': path.join(__dirname, './src/utils.tsx'),
